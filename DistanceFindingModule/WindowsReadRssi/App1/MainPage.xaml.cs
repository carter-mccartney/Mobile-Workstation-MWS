...
namespace App1
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        {
            return DateTimeOffset.Now.ToUnixTimeSeconds() - eventArgs.TimeStamp.ToUnixTimeSeconds() > 10;
        }
        ...
        private void UpdateAdvertisementList(object sender, object e)
        {
            ...
            vals.RemoveAll(delegate (AdvertisingDevice advertisingDevice)
            {
                ...
                return DateTimeOffset.Now.ToUnixTimeSeconds() - advertisingDevice.TimeStamp.ToUnixTimeSeconds() > 10;
            });
