...
/* The i2c_bus is the bus number used to communicate with the MPU9250.
 * The i2c_address is the i2c address of ther MPU9250.
 * I2c address is 1101000 when pin AD0 is pulled low and 1101001 when pin AD0 is pulled high.
 * The interrupt_gpio_pin is the input pin connected to the MPU9250's interrupt pin. (In our case, it is gpio 4.)
 */
